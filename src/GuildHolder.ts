...
export class GuildHolder {
    ...
    public async respondToConversation(channel: TextChannel | TextThreadChannel, message: Message) {
        ...
        const sharedPromptLines = [
            ...
            'All tools use semantic search so they can find relevant information when queries are full sentences.',
            "When you reference something from the archive search tool, mention the design's code in the response.",
            'NEVER use emojis or em-dashes, be concise as though you are chatting with a friend, and do not use more words or formatting than necessary.',
